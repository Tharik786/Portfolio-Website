      ...
      <div className="container-custom">
        ...
        <div className="max-w-4xl mx-auto mb-20">
          <motion.div variants={itemVariants}>
            ...
            <h3 className="text-xl text-gray-700 mb-6">Web Developer</h3>
            ...
            <p className="text-gray-700 mb-8 leading-relaxed">
              ...
              ReactJS for frontend development. On the backend, I work with Python
              and MySQL to develop scalable systems and manage data efficiently.
              This full-stack capability enables me to deliver comprehensive web
              solutions that align with business goals and exceed user
              expectations.
            </p>
            <button
