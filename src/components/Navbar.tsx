              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `relative font-medium hover:text-indigo-600 transition-colors ${
                    isActive ? 'text-indigo-600' : isScrolled ? 'text-gray-800' : 'text-gray-800'
                  }`
                }
              >
                {({ isActive }) => (
            ...
            {navItems.map((item) => (
              <li key={item.name}>
                <NavLink
                  to={item.path}
                  className={({ isActive }) =>
                    `block py-3 px-6 hover:bg-indigo-50 transition-colors ${
                      isActive ? 'text-indigo-600 bg-indigo-50' : 'text-gray-800'
                    }`
                  }
                >
                  {item.name}
